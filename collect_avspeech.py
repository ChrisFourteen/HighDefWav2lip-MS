...
parser.add_argument('--dataset_file', help='url video', default='avspeech_test.csv', type=str)
parser.add_argument('--is_vn', help='if vietnam dataset',  action='store_true', default=False)
parser.add_argument('--dataset_out', help='folder contain out dataset', default='avspeech', type=str)
parser.add_argument('--log_file', help='log_file', default='log.txt', type=str)
