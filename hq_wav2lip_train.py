...
parser.add_argument('--device_id', help='Resume quality disc from this checkpoint', default=None, type=int)
...
def train(device, model, disc, train_data_loader, test_data_loader, optimizer, disc_optimizer,
    ...
    while global_epoch < nepochs:
        ...
        for step, (x, indiv_mels, mel, gt) in prog_bar:
            ...
            prog_bar.set_description('step: {}, L1: {}, Sync: {}, Percep: {} | Fake: {}, Real: {}'.format(global_step,running_l1_loss / (step + 1),
