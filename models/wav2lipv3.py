...
from .conv3 import Conv2dTranspose, Conv2d, nonorm_Conv2d
...
class Wav2Lip(nn.Module):
    def __init__(self, audio_encoder=None):
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2d(6, 8, kernel_size=7, stride=1, padding=3, act="relu")), # 384, 384
            
            nn.Sequential(Conv2d(8, 16, kernel_size=3, stride=2, padding=1, act="relu"), # 192, 192
            Conv2d(16, 16, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(16, 16, kernel_size=3, stride=1, padding=1, residual=True, act="relu")),

            nn.Sequential(Conv2d(16, 32, kernel_size=3, stride=2, padding=1, act="relu"), # 96, 96
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="relu")),

            nn.Sequential(Conv2d(32, 64, kernel_size=3, stride=2, padding=1, act="relu"),    # 48, 48
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="relu")),

            nn.Sequential(Conv2d(64, 128, kernel_size=3, stride=2, padding=1, act="relu"),   # 24, 24
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="relu")),

            nn.Sequential(Conv2d(128, 256, kernel_size=3, stride=2, padding=1, act="relu"),       # 12, 12
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="relu")),

            nn.Sequential(Conv2d(256, 512, kernel_size=3, stride=2, padding=1, act="relu"),     # 6, 6
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),),
            ...
            # Modified blocks
            ##################
            nn.Sequential(Conv2d(512, 1024, kernel_size=3, stride=2, padding=1, act="relu"),       # 3, 3
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True, act="relu")),

            nn.Sequential(Conv2d(1024, 1024, kernel_size=3, stride=1, padding=0, act="relu"),     # 1, 1
            Conv2d(1024, 1024, kernel_size=1, stride=1, padding=0, act="relu")),])
            ##################


        self.audio_encoder = nn.Sequential(
            Conv2d(1, 32, kernel_size=3, stride=1, padding=1, act="relu"),
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),

            Conv2d(32, 64, kernel_size=3, stride=(3, 1), padding=1, act="relu"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),

            Conv2d(64, 128, kernel_size=3, stride=3, padding=1, act="relu"),
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),

            Conv2d(128, 256, kernel_size=3, stride=(3, 2), padding=1, act="relu"),
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            ...
            # Modified blocks
            ##################
            Conv2d(256, 512, kernel_size=3, stride=1, padding=1, act="relu"),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="relu"),
...
class Wav2Lip_disc_qual(nn.Module):
    def __init__(self):
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(nonorm_Conv2d(16, 32, kernel_size=5, stride=(1, 2), padding=2), # 192, 192
    ...
    def perceptual_forward(self, false_face_sequences, device):
